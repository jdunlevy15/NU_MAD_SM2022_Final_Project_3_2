...
public class FragmentCreateDogProfile extends Fragment {
    ...
    // view items needed
    private EditText dogNameET, dogAgeET, dogBreedET, dogColorET, dogCurrentSizeET, dogPotentialSizeET, dogDescriptionET;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dogDescriptionET = view.findViewById(R.id.editTextCreateDescription);
